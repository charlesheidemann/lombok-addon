== lombok-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The lombok-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.jboss.forge.addon.lombok</groupId>
   <artifactId>lombok-addon</artifactId>
